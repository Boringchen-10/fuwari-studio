...
$releaseRoot = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot '../release-v020'))
$appRoot = Join-Path $releaseRoot 'Blog Studio v0.2.0-win32-x64'
$archivePath = Join-Path $releaseRoot 'Blog-Studio-v0.2.0-Windows-x64.zip'
