...
v0.1.1 新增 GitHub Pages 发布，配置步骤见 resources/app/GITHUB.md。支持公开的 用户名.github.io 主页仓库，可在服务器连接页面切换发布方式。当前不含双向同步、从服务器下载源码、自动更新或代码签名。别人收到程序后创建自己的博客、填写自己的连接资料。程序不含原作者的私人博客或凭据。
